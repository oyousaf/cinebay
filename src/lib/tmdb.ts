...
/** Logic genres only. Lower-case strings for filtering. */
...
function toMovie(
  ...
  return {
    ...
    /* ---------- GENRES ---------- */
    genres: extractGenres(detail), // logic
    genres_raw: Array.isArray(detail?.genres) ? detail.genres : [], // UI
