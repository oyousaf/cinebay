    ...
    <div className="relative w-full h-[70vh] sm:h-full flex flex-col justify-end overflow-hidden shadow-2xl snap-start">
      ...
      >
        ...
        <motion.p
          ...
          sm:overflow-visible sm:h-auto md:h-[7.5rem] md:overflow-y-auto lg:overflow-visible lg:h-auto scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-transparent md:border md:border-zinc-700/60 md:bg-black/25 md:shadow-inner"
          style={{
