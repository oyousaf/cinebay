          ...
          >
            <div className="flex flex-col sm:flex-row gap-6 sm:items-start">
              ...
              <div className="flex-1 space-y-4">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-3 items-center text-sm sm:text-base text-zinc-300 pt-2">
                  {movie.isNew && (
                    <span
                      className="bg-amber-400 text-black text-xs font-bold px-2 py-0.5 rounded shadow"
                      style={{
