          ...
          {cast.map((actor, i) => (
            <span key={actor.id}>
              <button
                ...
                className="underline underline-offset-2 transition hover:text-[hsl(var(--foreground))] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[hsl(var(--foreground))]"
              >
                {actor.name}
              </button>
              {i < cast.length - 1 && ", "}
